...
// Setup mocks BEFORE bundle runs
var window = {scrollTo: () => {}, addEventListener: () => {}, document: undefined, devicePixelRatio: 1};
window = globalThis;
var document = {createElement: () => ({relList: {supports: () => false}, href: ''}), addEventListener: () => {}, body: {appendChild: () => {}, addEventListener: () => {}, setAttribute: () => {}, className: '', querySelectorAll: () => [], querySelector: () => null, getElementsByTagName: () => [], getContext: () => ({clearRect: () => {}, beginPath: () => {}, moveTo: () => {}, lineTo: () => {}, stroke: () => {}, fillText: () => {}, fillRect: () => {}, scale: () => {}, setTransform: () => {}, fillStyle: '', strokeStyle: ''}), style: {}}, querySelectorAll: () => [], querySelector: () => null, getElementsByTagName: () => [], readyState: 'complete', documentElement: {style: {}}, addEventListener: () => {}};
