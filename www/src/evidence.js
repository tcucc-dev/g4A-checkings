...
const EVIDENCE_REPORTS = [
  {
    ...
    period:"2026-07-20 至 2026-07-26（7 個完整週，週標籤為週日，06/21 缺資料）", maxDate:"2026-08-01", generatedAt:"2026-08-03T09:00:00Z",
    jobId:"not captured", dataHash:"sha256:e407559ba9cdd8d37f3d5b949bc123c18ea437ec900bd23da8844e5c1aca47a3", status:"正常",
    ...
    rows:[
    {week:"06/07",sessions:18096,pageviews:27546,users:8247,engagement_seconds:7.8,pages_per_session:1.47},
    {week:"06/14",sessions:22430,pageviews:33085,users:11601,engagement_seconds:5.6,pages_per_session:1.43},
    {week:"06/28",sessions:18686,pageviews:28023,users:8039,engagement_seconds:5.7,pages_per_session:1.46},
    {week:"07/05",sessions:14352,pageviews:21667,users:6077,engagement_seconds:7.0,pages_per_session:1.48},
    {week:"07/12",sessions:10927,pageviews:16051,users:5317,engagement_seconds:7.6,pages_per_session:1.45},
    {week:"07/19",sessions:11128,pageviews:18863,users:5335,engagement_seconds:6.8,pages_per_session:1.67},
    {week:"07/26",sessions:10500,pageviews:15026,users:5669,engagement_seconds:6.3,pages_per_session:1.41}
  ],
    sql:"SELECT week, COUNT(DISTINCT ga_session_id) AS sessions, COUNTIF(event_name='page_view') AS pageviews, COUNT(DISTINCT user_pseudo_id) AS users, ROUND(SAFE_DIVIDE(SUM(engagement_time_msec)/1000.0, COUNT(DISTINCT ga_session_id)), 0) AS engagement_seconds, ROUND(SAFE_DIVIDE(COUNTIF(event_name='page_view'), COUNT(DISTINCT ga_session_id)), 2) AS pages_per_session FROM all_units_summary WHERE site_name='慈濟大學中文版首頁' AND date BETWEEN DATE '2026-06-01' AND DATE '2026-07-26' GROUP BY week ORDER BY week;"
  },
  {
    ...
    period:"2026-07-20 至 2026-07-26（7 個完整週，週標籤為週日，06/21 缺資料）", maxDate:"2026-08-01", generatedAt:"2026-08-03T09:00:00Z",
    jobId:"not captured", dataHash:"sha256:f2f8d467136f3c67de3d0e984b37a021f4e88736c7bbb792f2e79c32d353c92c", status:"正常",
  ...
  },
  {
    ...
    sql:"SELECT url, REGEXP_REPLACE(url, r'^https?://[^/]+', '') AS path, SUM(impressions) AS imp, SUM(clicks) AS clk, ROUND(SUM(sum_position) / NULLIF(SUM(impressions), 0), 1) AS avg_pos FROM all_gsc_summary WHERE site_name='慈濟大學中文版首頁' AND data_date BETWEEN DATE '2026-07-20' AND DATE '2026-07-26' GROUP BY url ORDER BY imp DESC LIMIT 20;"
  },
  {
    ...
    period:"2026-07-20 至 2026-07-26（7 個完整週，週標籤為週日，06/21 缺資料）", maxDate:"2026-08-01", generatedAt:"2026-08-03T09:00:00Z",
    jobId:"not captured", dataHash:"sha256:8ba99f1e5eb9cbb2cf28431ed27b3342cd2e59f8cc3743fdb9cee0ffce4f4c83", status:"注意",
    ...
    sql:"SELECT query, SUM(impressions) AS imp, SUM(gsc_clicks) AS clk, SUM(total_behavior_events) AS behavior_events, COUNT(DISTINCT url) AS pages_count FROM search_behavior_summary WHERE site_name='慈濟大學中文版首頁' AND date BETWEEN DATE '2026-07-20' AND DATE '2026-07-26' AND query IS NOT NULL AND query != '' GROUP BY query ORDER BY imp DESC LIMIT 20;"
  },
  {
    ...
    period:"2026-07-20 至 2026-07-26（7 個完整週，週標籤為週日，06/21 缺資料）", maxDate:"2026-08-01", generatedAt:"2026-08-03T09:00:00Z",
    jobId:"not captured", dataHash:"sha256:96a425671ae3c67e2284061c8e12d0413651665e36c2cfa0b85257b832f0e63c", status:"查詢可用",
  ...
  },
  {
    ...
    period:"2026-07-20 至 2026-07-26（7 個完整週，週標籤為週日，06/21 缺資料）", maxDate:"2026-08-01", generatedAt:"2026-08-03T09:00:00Z",
    jobId:"not captured", dataHash:"sha256:a155cdb8712f5d1ca21ace64a0502ce6aed8e6073c5f55857970d84e036f9b56", status:"正常",
    ...
    sql:"SELECT 'all_units_summary' AS table_name, MAX(date) AS max_date, COUNT(*) AS recent_rows FROM all_units_summary WHERE site_name='慈濟大學中文版首頁' AND date BETWEEN DATE '2026-07-20' AND DATE '2026-07-26' UNION ALL SELECT 'all_gsc_summary', MAX(data_date), COUNT(*) FROM all_gsc_summary WHERE site_name='慈濟大學中文版首頁' AND data_date BETWEEN DATE '2026-07-20' AND DATE '2026-07-26' UNION ALL SELECT 'search_behavior_summary', MAX(date), COUNT(*) FROM search_behavior_summary WHERE site_name='慈濟大學中文版首頁' AND date BETWEEN DATE '2026-07-20' AND DATE '2026-07-26';"
  },
  {
    ...
    period:"2026-07-20 至 2026-07-26（7 個完整週，週標籤為週日，06/21 缺資料）", maxDate:"2026-08-01", generatedAt:"2026-08-03T09:00:00Z",
    jobId:"not captured", dataHash:"sha256:9435f989d27cc668af4bd9649377dac650b4b4ad99ff734fcfa7668f2873921a", status:"查詢可用",
    ...
    rows:[
    {week:"06/07",course_pv:13,faculty_pv:0,feature_pv:17},
    {week:"06/14",course_pv:27,faculty_pv:0,feature_pv:28},
    {week:"06/28",course_pv:19,faculty_pv:0,feature_pv:28},
    {week:"07/05",course_pv:10,faculty_pv:0,feature_pv:19},
    {week:"07/12",course_pv:8,faculty_pv:0,feature_pv:14},
    {week:"07/19",course_pv:66,faculty_pv:0,feature_pv:118},
    {week:"07/26",course_pv:11,faculty_pv:0,feature_pv:23}
  ],
    sql:"SELECT FORMAT_DATE('%m/%d', DATE_ADD(DATE_TRUNC(date, WEEK(MONDAY)), INTERVAL 6 DAY)) AS week, SUM(CASE WHEN page_title LIKE '%課程地圖%' OR page_title LIKE '%課程規劃%' OR page_title LIKE '%碩士班專區%' THEN 1 ELSE 0 END) AS course_pv, SUM(CASE WHEN page_title LIKE '%師資陣容%' THEN 1 ELSE 0 END) AS faculty_pv, SUM(CASE WHEN page_title LIKE '%本系特色%' OR page_title LIKE '%業界實習%' OR page_title LIKE '%實習流程%' OR page_title LIKE '%實務專題%' THEN 1 ELSE 0 END) AS feature_pv FROM all_units_summary WHERE site_name='慈濟大學中文版首頁' AND date BETWEEN DATE '2026-06-01' AND DATE '2026-07-26' AND page_title != '' GROUP BY week ORDER BY week;"
  },
  {
    ...
    period:"2026-07-20 至 2026-07-26（7 個完整週，週標籤為週日，06/21 缺資料）", maxDate:"2026-08-01", generatedAt:"2026-08-03T09:00:00Z",
    jobId:"not captured", dataHash:"sha256:50e0f301c00c3464df49bcd4263ed68777a39c58a1470ed4d61077ff4cea04c5", status:"資料正常",
    ...
    sql:"SELECT '電話' AS type, 'TCU 系辦' AS name, '+886-3-8572677' AS value, COUNT(*) AS clicks FROM all_units_summary WHERE site_name='慈濟大學中文版首頁' AND link_url LIKE '%tel:%' AND date BETWEEN DATE '2026-07-20' AND DATE '2026-07-26' UNION ALL SELECT 'Email', '資管系聯絡信箱', 'www@tcu.edu.tw', COUNT(*) FROM all_units_summary WHERE site_name='慈濟大學中文版首頁' AND (link_url LIKE '%mailto:www%' OR link_text LIKE '%www%@%') AND date BETWEEN DATE '2026-07-20' AND DATE '2026-07-26';"
  },
  {
    id:"EV-GEO-SOURCE-001", title:"GEO 技術原始碼完整檢核報表", sourceType:"網站原始碼掃描",
    sourceTable:"首頁 HTML", queryCode:"SITE-SOURCE-001",
    period:"2026-07-20 至 2026-07-26（7 個完整週，週標籤為週日，06/21 缺資料）", maxDate:"2026-08-01", generatedAt:"2026-08-03T09:00:00Z",
    jobId:"非 BigQuery", dataHash:"sha256:1d02187be1ecb20c799c8a122917de9b6217de80e9c0190f6acb6826732c9ed2", status:"需改善",
  ...
  },
  {
    ...
    period:"2026-07-20 至 2026-07-26（7 個完整週，週標籤為週日，06/21 缺資料）", maxDate:"2026-08-01", generatedAt:"2026-08-03T09:00:00Z",
    jobId:"not captured", dataHash:"sha256:a204b2643cfc1d3d13078f95c5c6d58217b4abe7b7be098c1d12d1d1d44cdac9", status:"需改善",
  ...
  },
  {
    ...
    period:"2026-07-20 至 2026-07-26（7 個完整週，週標籤為週日，06/21 缺資料）", maxDate:"2026-08-01", generatedAt:"2026-08-03T09:00:00Z",
    jobId:"not captured", dataHash:"sha256:b09b257e2b7326446156e12d92021a5327d82f4c454a80b5f0127f751f2c6ca3", status:"資料正常",
  ...
  // ===== Section 4 audit (v56) — 9 new evidence records =====
  {
    ...
    period:"2026-07-20 至 2026-07-26（7 個完整週，週標籤為週日，06/21 缺資料）", maxDate:"2026-08-01", generatedAt:"2026-08-03T09:00:00Z",
    jobId:"not captured", dataHash:"sha256:3a6cb2a86f33835e8c5bc5248647f80626b697c7c25894676fb57e79dd40b113", status:"正常",
  ...
  },
  {
    ...
    period:"2026-07-20 至 2026-07-26（7 個完整週，週標籤為週日，06/21 缺資料）", maxDate:"2026-08-01", generatedAt:"2026-08-03T09:00:00Z",
    jobId:"not captured", dataHash:"sha256:eefbeef44cfecd6ea3dbd76f14be9605e3aa6a0f74fabdd890e13f9c071826ce", status:"正常",
  ...
  },
  {
    ...
    period:"2026-07-20 至 2026-07-26（7 個完整週，週標籤為週日，06/21 缺資料）", maxDate:"2026-08-01", generatedAt:"2026-08-03T09:00:00Z",
    jobId:"not captured", dataHash:"sha256:584f677fbed49b83cda8a1517cba7150b748a4f331fba6dfa7711edaf334366e", status:"正常",
  ...
  },
  {
    ...
    period:"2026-07-20 至 2026-07-26（7 個完整週，週標籤為週日，06/21 缺資料）", maxDate:"2026-08-01", generatedAt:"2026-08-03T09:00:00Z",
    jobId:"not captured", dataHash:"sha256:5df689224bd82dd779bf178f8f97b6adb5dac357eacf8ffbcb77e55827c785f0", status:"正常",
    ...
    {group:"referral",source:"tw.search.yahoo.com",medium:"referral",sessions:78,users:46,avg_eng_sec_per_session:nan,internal_clicks:0,downloads:0,cta_clicks:0,sample_note:"足夠"},
    ...
    {group:"referral",source:"jctv.ntut.edu.tw",medium:"referral",sessions:9,users:8,avg_eng_sec_per_session:nan,internal_clicks:0,downloads:0,cta_clicks:0,sample_note:"足夠"},
    {group:"referral",source:"tcunew.tcust.edu.tw",medium:"referral",sessions:8,users:2,avg_eng_sec_per_session:nan,internal_clicks:0,downloads:0,cta_clicks:0,sample_note:"足夠"},
    {group:"referral",source:"tzuchi.org.tw",medium:"referral",sessions:6,users:4,avg_eng_sec_per_session:nan,internal_clicks:0,downloads:0,cta_clicks:0,sample_note:"足夠"},
    {group:"referral",source:"m.facebook.com",medium:"referral",sessions:5,users:5,avg_eng_sec_per_session:nan,internal_clicks:0,downloads:0,cta_clicks:0,sample_note:"足夠"},
    {group:"referral",source:"ntp.msn.com",medium:"referral",sessions:5,users:1,avg_eng_sec_per_session:nan,internal_clicks:0,downloads:0,cta_clicks:0,sample_note:"足夠"},
    {group:"referral",source:"collego.edu.tw",medium:"referral",sessions:4,users:1,avg_eng_sec_per_session:nan,internal_clicks:0,downloads:0,cta_clicks:0,sample_note:"資料不足"},
    {group:"referral",source:"wwwc.moex.gov.tw",medium:"referral",sessions:4,users:4,avg_eng_sec_per_session:nan,internal_clicks:0,downloads:0,cta_clicks:0,sample_note:"資料不足"},
    {group:"referral",source:"m.baidu.com",medium:"referral",sessions:4,users:4,avg_eng_sec_per_session:nan,internal_clicks:0,downloads:0,cta_clicks:0,sample_note:"資料不足"},
    {group:"organic",source:"yahoo",medium:"organic",sessions:4,users:4,avg_eng_sec_per_session:nan,internal_clicks:0,downloads:0,cta_clicks:0,sample_note:"資料不足"},
    {group:"referral",source:"wifi.tcust.edu.tw:1000",medium:"referral",sessions:3,users:2,avg_eng_sec_per_session:nan,internal_clicks:0,downloads:0,cta_clicks:0,sample_note:"資料不足"},
    {group:"referral",source:"104.com.tw",medium:"referral",sessions:3,users:3,avg_eng_sec_per_session:nan,internal_clicks:0,downloads:0,cta_clicks:0,sample_note:"資料不足"},
    {group:"referral",source:"jingsi.org",medium:"referral",sessions:3,users:3,avg_eng_sec_per_session:nan,internal_clicks:0,downloads:0,cta_clicks:0,sample_note:"資料不足"},
    {group:"referral",source:"tw.tzuchi.org",medium:"referral",sessions:3,users:3,avg_eng_sec_per_session:nan,internal_clicks:0,downloads:0,cta_clicks:0,sample_note:"資料不足"},
    {group:"referral",source:"cse.google.com",medium:"referral",sessions:3,users:1,avg_eng_sec_per_session:nan,internal_clicks:0,downloads:0,cta_clicks:0,sample_note:"資料不足"}
  ],
    sql:"SELECT CASE WHEN source='(direct)' OR medium='(none)' THEN 'Direct' WHEN source='google' AND medium='organic' THEN 'Organic Search' WHEN REGEXP_CONTAINS(COALESCE(page_referrer,''), r'chatgpt|perplexity|gemini|copilot|claude|openai') THEN 'AI Referral' WHEN medium='referral' AND source LIKE '%edu%' OR source LIKE 'lle%' THEN 'Internal Referral' WHEN medium='referral' THEN 'External Referral' WHEN source='facebook.com' OR source='twitter.com' OR medium='social' THEN 'Social' ELSE 'Other' END AS group, source, medium, COUNT(DISTINCT ga_session_id) AS sessions, COUNT(DISTINCT user_pseudo_id) AS users, ROUND(SAFE_DIVIDE(SUM(engagement_time_msec)/1000.0, COUNT(DISTINCT ga_session_id)), 1) AS avg_eng_sec_per_session, SUM(CASE WHEN event_name='click' AND link_class IN ('internal-cta','internal-link') THEN 1 ELSE 0 END) AS internal_clicks, SUM(CASE WHEN link_url LIKE '%.pdf' OR link_url LIKE '%.doc%' OR link_url LIKE '%.xls%' THEN 1 ELSE 0 END) AS downloads, SUM(CASE WHEN event_name='click' AND link_class='admission-cta' THEN 1 ELSE 0 END) AS cta_clicks FROM all_units_summary WHERE site_name='慈濟大學中文版首頁' AND date BETWEEN DATE '2026-07-20' AND DATE '2026-07-26' GROUP BY group, source, medium ORDER BY sessions DESC;"
  },
  {
    id:"EV-AI-DETECTION-RULES-001", title:"AI 平台 referrer 完整報表（已修正）", sourceType:"BigQuery",
    sourceTable:"all_units_summary", queryCode:"AI-REFERRAL-EVIDENCE-001",
    period:"2026-07-20 至 2026-07-26（7 個完整週，週標籤為週日，06/21 缺資料）", maxDate:"2026-08-01", generatedAt:"2026-08-03T09:00:00Z",
    jobId:"not captured", dataHash:"sha256:06db053d3c3df05590b52c52c9401e8f4e374f5c0da4ee71b621f0f27f06e971", status:"已說明",
  ...
  },
  {
    ...
    period:"2026-07-20 至 2026-07-26（7 個完整週，週標籤為週日，06/21 缺資料）", maxDate:"2026-08-01", generatedAt:"2026-08-03T09:00:00Z",
    jobId:"not captured", dataHash:"sha256:389ccb00c87f642bc02290cee5bfc5030b90ed6a0fbfe7872163066070d14ad9", status:"行動代理指標",
    ...
    {category:"其他連結", link_text:"nan", source_page:"p/404-1022-60990.php?Lang=zh-tw", destination:"https://www.tcust.edu.tw/var/file/22/1022/img/1843/540712717.doc", clicks:6, users:2, valid_events:0, valid_rate:0},
    ...
    {category:"其他連結", link_text:"nan", source_page:"p/404-1022-36099.php", destination:"https://www.tcust.edu.tw/var/file/22/1022/img/1214/686385563.ods", clicks:5, users:3, valid_events:0, valid_rate:0},
  ...
  },
  {
    ...
    period:"2026-07-20 至 2026-07-26（7 個完整週，週標籤為週日，06/21 缺資料）", maxDate:"2026-08-01", generatedAt:"2026-08-03T09:00:00Z",
    jobId:"not captured", dataHash:"sha256:97b54fce44b38d8399b6969b9c08098e2d352abdbf7125f51d9f3c2e5acccb9f", status:"正常",
  ...
  },
  {
    ...
    period:"2026-07-20 至 2026-07-26（7 個完整週，週標籤為週日，06/21 缺資料）", maxDate:"2026-08-01", generatedAt:"2026-08-03T09:00:00Z",
    jobId:"not captured", dataHash:"sha256:871f31ee1f7126f5b5e4dae3cea6eeea3a28d4bb810f449cfa35328f9b65e03e", status:"路徑代理",
  ...
  },
  {
    ...
    period:"2026-07-20 至 2026-07-26（7 個完整週，週標籤為週日，06/21 缺資料）", maxDate:"2026-08-01", generatedAt:"2026-08-03T09:00:00Z",
    jobId:"not captured", dataHash:"sha256:01f9958901555556f7ad05fe26f9ee66ea6fe219630a16069b4b50ca07cbafb7", status:"待改善",
    ...
    sql:"SELECT 'missing_jsonld' AS issue_type, COUNTIF(REGEXP_CONTAINS(body, r'application/ld\+json')) AS affected_count FROM `project.all_units_summary` WHERE site_name='慈濟大學中文版首頁' AND date BETWEEN DATE '2026-07-20' AND DATE '2026-07-26' UNION ALL /* … */ ;"
  }
];
