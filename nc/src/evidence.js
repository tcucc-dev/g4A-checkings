...
const EVIDENCE_REPORTS = [
  ...
  },
  {
    ...
    {category:"內容結構", check_item:"h2 數量", result:"待改善", issue_count:1, evidence:"h2 數量從 20 降至 5，可能影響內容結構與可擷取性", owner:"電算中心"},
    {category:"圖片", check_item:"alt 屬性", result:"待修補", issue_count:6, evidence:"9 張 img 中 6 張缺少 alt 屬性", owner:"電算中心"},
    {category:"DOM", check_item:"重複 ID", result:"待修補", issue_count:30, evidence:"偵測到 30+ 重複 ID (Hln_* 系列、TcuRpageFeatureTitle 等)", owner:"電算中心"}
  ],
