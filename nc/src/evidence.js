...
const EVIDENCE_REPORTS = [
  ...
  },
  {
    ...
    {category:"結構化資料", check_item:"JSON-LD EducationalOrganization", result:"已實作", issue_count:0, evidence:"含 name、alternateName、url、parentOrganization、knowsAbout、address", owner:"—"},
    ...
    {category:"Open Graph", check_item:"og:image", result:"待觀察", issue_count:1, evidence:"指向系統路徑 /var/file/14/1014/msys_1014_2081373_28918.png", owner:"電算中心"},
    ...
    {category:"DOM", check_item:"重複 ID", result:"待修補", issue_count:29, evidence:"29 個 DOM ID 重複（多為 Hln_* template-generated）", owner:"電算中心"}
  ],
  ...
  },
  {
    ...
    {query:"慈濟大學護理", cls:"nonbrand", imp:11, clicks:0, ctr:0, avg_pos:1, landing:"/"},
    ...
    {query:"慈濟大學護理科", cls:"nonbrand", imp:9, clicks:1, ctr:11.11, avg_pos:2.1, landing:"/"},
    {query:"慈濟大學護理學院", cls:"nonbrand", imp:9, clicks:1, ctr:11.11, avg_pos:0, landing:"/p/412-1014-2992.php"}
  ],
  ...
  },
  {
    ...
    {category:"其他連結", link_text:"01 最新消息 查看學院最新消息、活動公告與重要資訊。 ›", source_page:"", destination:"https://nc.tcu.edu.tw/#Dyn_2_9", clicks:4, users:4, valid_rate:1},
    {category:"其他連結", link_text:"04 師資成員 查看教師專長、研究與教學領域。 ›", source_page:"", destination:"https://nc.tcu.edu.tw/p/412-1014-2992.php", clicks:4, users:4, valid_rate:1}
  ],
