...
// Layout uses HTML elements defined in www/index.html (Section 4).
...
// window-stable name. The minifier reorders const decls vs function decls
// in ways that put const Ue/On/dpr in TDZ when the chart functions try
// to read them. Using (0,eval)("window") is un-foolable by the minifier.
try {
...
// Wait for DOM + data to be ready, then render
