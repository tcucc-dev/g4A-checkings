const GLOSSARY_DB = {
  ...
  "all_gsc_summary": "這是放所有系所「Google 搜尋曝光與點擊」資料的總表。報告只取 TCU 資管的部分。",
  "all_unit_summary": "拼字錯誤，正確為 all_units_summary。",
  "all_units_summary": "這是放整個慈濟大學「所有 97 個系所」上網資料的總表。報告只取 TCU 資管的數字，需要先過濾。",
  ...
  "view": "瀏覽。",
  "主題與實體清楚度": "首頁有沒有清楚告訴 Google「這是哪個學校、哪個系」。<br><br>📝 例子：好 = 標題寫「慈濟大學資訊科技與管理學系」；不好 = 只寫「首頁」或「歡迎光臨」。",
  ...
  "DOM ID": "HTML 元素的 id 屬性。同一頁面內 id 必須唯一。重複的 id 會破壞 JavaScript selector、ARIA 與無障礙工具。TCU 首頁偵測到 80 處重複。",
  "Widget": "頁面中的一個互動小區塊（例如嵌入的 YouTube 影片、地圖、聯絡表單）。TCU 首頁有 26 個 iframe widget，全部缺 title 屬性。",
  ...
  "Hln_*": "範本自動產生的 HTML id 前綴（例如 Hln_a1b2）。同一個頁面上 id 必須唯一，重複的 id 會破壞 JavaScript selector、ARIA 與螢幕閱讀器的可訪問性。TCU 首頁偵測到 80 處這類 id 衝突。",
