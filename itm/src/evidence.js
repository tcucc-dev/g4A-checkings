...
const EVIDENCE_REPORTS = [
  ...
  },
  {
    ...
    {category:"Meta", check_item:"description 長度", result:"待修補", issue_count:1, evidence:"0 字（已從 154 字被清空，建議恢復 150–160 字 SEO keywords）", owner:"電算中心"},
    ...
    {category:"DOM", check_item:"重複 ID", result:"待修補", issue_count:2, evidence:"2 個 DOM ID 重複（google-fonts-css, main-content）", owner:"電算中心"}
  ],
