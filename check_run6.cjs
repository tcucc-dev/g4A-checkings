...
const fs = require('fs');
const code = fs.readFileSync('C:/Users/user/Documents/g4A-checkings/check_actual_bundle.js', 'utf-8');
...
console.log("window.evidence:", typeof window.evidence);
console.log("window.issue:", typeof window.issue);
