...
console.log("setView:", typeof globalThis.window.setView);
console.log("init:", typeof globalThis.window.init);
console.log("draw:", typeof globalThis.window.draw);
