...
const fakeWindow = { addEventListener: () => {}, DeviceOrientationEvent: undefined };
const fakeDocument = { 
  createElement: () => ({ relList: { supports: () => false } }),
  readyState: 'complete',
  querySelectorAll: () => [],
  addEventListener: () => {},
  body: { appendChild: () => {}, addEventListener: () => {}, setAttribute: () => {}, className: '' },
